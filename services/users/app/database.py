"""
Database configuration and session management for the Users service.
...
DATABASE_URL = os.getenv("DATABASE_URL", "postgresql://users:users123@localhost:5432/usersdb")
